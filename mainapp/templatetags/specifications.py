...
PRODUCT_SPEC = {
    ...
    'smartphone': {
        ...
        'Максимальный объём встраиваемой памяти': 'sd_volume_max',
...
def product_spec(product):
    ...
    if isinstance(product, Smartphone):
        if not product.sd:
            PRODUCT_SPEC['smartphone'].pop('Максимальный объём встраиваемой памяти')
        else:
            PRODUCT_SPEC['smartphone']['Максимальный объём встраиваемой памяти'] = 'sd_volume_max'
